...
/*module "aws-vpc" {
*  source = "/home/terraform-kubespray/kubespray/contrib/terraform/aws/modules/vpc"
*
...
/*
*module "aws-elb" {
*  source = "/home/terraform-kubespray/kubespray/contrib/terraform/aws/modules/elb"
*
*  aws_cluster_name      = "${var.aws_cluster_name}"
...
module "aws-iam" {
  source = "/home/terraform-kubespray/kubespray/contrib/terraform/aws/modules/iam"
