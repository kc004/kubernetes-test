# IAM Roles for Kubernetes master and worker
...
# IAM Role Policy for Kubernetes Master
...
# IAM Role Policy for Kubernetes Worker
...
# Instance Profiles to attach to EC2 instances
